            ...
            <div className={style.navbar2 }>
                ...
                <div  className={style.buttonBox}  onClick={()=> {setOption3(!option3); setOption1(false); setOption2(false); setOption4(false)}} >
                  ...
                  <div className={option3 ? style.optionOpen : style.optionClose} >
                    <Link href="/v1/setupcryptowallet"><h5 className={style.h5animate}>• How to Buy?</h5></Link>
                    <Link href="/v1/process"><h5 className={style.h5animate}>• How to Trade?</h5></Link>
                ...
                <div  className={style.buttonBox}  onClick={()=> {setOption4(!option4); setOption1(false); setOption2(false); setOption3(false)}}>
                  ...
                  <div className={option4 ? style.optionOpen : style.optionClose} >
                    ...
                    <Link href="/v1/rckventures/rpsnftgame"><h5 className={style.h5animate}>• The RPS NFT GAME</h5></Link>
                    <Link href="/v1/rckventures/gamemechanics"><h5 className={style.h5animate}>• Game Mechanics</h5></Link>
                    <Link href="/v1/rckventures/rpsnftgame"><h5 className={style.h5animate}>• RPS AXESS Card</h5></Link>
                ...
                <div  className={style.buttonBox}  onClick={()=> {setOption1(!option1); setOption3(false); setOption2(false); setOption4(false)}} >
                  ...
                  <div className={option1 ? style.optionOpen : style.optionClose} >
                    <Link href="/v1/abstractandbackdrop"><h5 className={style.h5animate}>• Blockchain</h5></Link>
                    <Link href="/v1/abstractandbackdrop#cryptocurrency"><h5 className={style.h5animate}>• Cryptocurrency</h5></Link>
                    <Link href="/v1/abstractandbackdrop#nft"><h5 className={style.h5animate}>• NFT</h5></Link>
